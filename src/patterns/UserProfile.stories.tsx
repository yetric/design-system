...
const posts = [
  ...
  {
    id: 2,
    title: "Why component-driven design matters",
    likes: 89,
    comments: 14,
    time: "5 days ago",
  },
  {
    id: 3,
    title: "Tailwind CSS tips for design engineers",
    likes: 201,
    comments: 43,
    time: "1 week ago",
  },
      ...
      <Stack gap={6}>
        ...
        <Box px="xs">
          <Stack gap={2}>
            ...
            <Text size="body-sm" color="muted">
              Product designer and design engineer. Building tools that help teams ship better
              software faster.
            </Text>
            <Stack direction="row" wrap="wrap" gap={4} style={{ marginTop: "0.25rem" }}>
              <Stack direction="row" align="center" gap={1}>
                <MapPin style={metaIconStyle} />
                <Text as="span" size="body-sm" color="muted">
                  Berlin, Germany
                </Text>
              </Stack>
              <Stack direction="row" align="center" gap={1}>
                <LinkIcon style={metaIconStyle} />
                <Text as="span" size="body-sm" color="muted">
                  sofia.design
                </Text>
              </Stack>
        ...
        <Tabs defaultValue="posts">
          <TabsList variant="underline">
            ...
            <TabsTrigger value="repos" variant="underline">
              Repositories
            </TabsTrigger>
          </TabsList>
                  ...
                  <CardContent style={{ paddingTop: 16 }}>
                    <Stack gap={2}>
                      ...
                      <Stack direction="row" align="center" gap={4}>
                        ...
                        <Text as="span" size="caption" color="muted" style={{ marginLeft: "auto" }}>
                          {post.time}
                        </Text>
                      </Stack>
                    </Stack>
          ...
          <TabsContent value="about">
            <Stack gap={2} style={{ paddingTop: "1rem" }}>
              <Text size="body-sm" color="muted">
                Sofia is a product designer focused on design systems and component libraries.
              </Text>
              <Text size="body-sm" color="muted">
                She regularly speaks at conferences about accessible UI and open-source
                collaboration.
              </Text>
            </Stack>
          </TabsContent>
          ...
          <TabsContent value="repos">
            <Text size="body-sm" color="muted" style={{ paddingTop: "1rem" }}>
